...
class LinearNeRFModel(NeRFModel):
    ...
    def populate_modules(self):
        ...
        # samplers
        self.sampler_uniform = LinearUniformSampler(num_samples=self.config.num_coarse_samples)
    ...
    def get_outputs(self, ray_bundle: RayBundle, **kwargs):
        ...
        weights_coarse, densities_coarse, transmittance_coarse = ray_samples_uniform.get_weights_linear(field_outputs_coarse[FieldHeadNames.DENSITY])
